...
-- Print wether the card number is a valid credit card number
--visaCardNumber = 4556641618423 :: Integer
--americanExpressCardNumber = 373993851220785 :: Integer
--masterCardNumber = 5580907293574128 :: Integer
--main = do
--        --print (luhn masterCardNumber)
--        print (isMaster masterCardNumber)
--        print (isVisa masterCardNumber)
--        print (isAmericanExpress masterCardNumber)
--        print("---------")
--        print (isMaster visaCardNumber)
--        print (isVisa visaCardNumber)
--        print (isAmericanExpress visaCardNumber)
--        print("---------")
--        print (isMaster americanExpressCardNumber)
--        print (isVisa americanExpressCardNumber)
--        print (isAmericanExpress americanExpressCardNumber)
--        --print("test")

-- Print test results
--main = print(ex3 5)
--main = quickCheck ex3WrapperTest
--main = print (arrayToString (reverse [1, 2, 3, 4, 5, 6]) 0)
--main = print (getNumberOfCard [1, 2, 3, 4, 5, 6] 4)
--main = print (luhn cardNumber)
--main = print (luhn1stTo2ndRow (getDigitsHelper masterCardNumber) 0)
--main = print (luhn2ndTo3rdRow (luhn1stTo2ndRow (getDigitsHelper masterCardNumber) 0))