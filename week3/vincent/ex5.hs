-- ID: 11408227
-- Name: Vincent Jong
-- Time: 13:00 - 14:10 (Programming), (Testing), (Answering)
...
form2Clause (Dsj list) = forms2Clause list
...
main = do
    print $ cnf2cls testForm1
    print $ cnf2cls testForm2
    print $ cnf2cls testForm3
    print $ cnf2cls testForm4
    print $ cnf2cls testForm5